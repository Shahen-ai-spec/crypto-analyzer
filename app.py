...
4. **Stop Loss (SL) & Take Profit (TP1)**:
   - Αν υπάρχει εργαλείο Long/Short Position στο chart, διάβασε ΑΚΡΙΒΩΣ τους αριθμούς του.
   - Αν ΔΕΝ υπάρχει εργαλείο, υπολόγισε με βάση τα Swing Highs/Lows:
     * Για SHORT: SL = πάνω από το τελευταίο τοπικό υψηλό (+0.2%), TP1 = στο κοντινότερο Support.
     * Για LONG: SL = κάτω από το τελευταίο τοπικό χαμηλό (-0.2%), TP1 = στο κοντινότερο Resistance.
   - Εξασφάλισε ελάχιστο Risk/Reward 1:1.5.
